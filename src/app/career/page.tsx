...
export const metadata = {
  ...
  description:
    "Join Ocean Academy's passionate team in Puducherry. Explore current job openings in IT training, development, and support. Apply now and grow with us.",
  keywords:
    "Careers at Ocean Academy, job openings Puducherry, IT trainer jobs, web development jobs, Ocean Academy hiring, software training career",
};
...
export default function CareerPage() {
  ...
  const jobPostingSchema = jobs.map((job) => ({
    ...
    datePosted: "2025-09-17", // ideally use dynamic new Date().toISOString().split("T")[0]
    hiringOrganization: {
      "@type": "Organization",
      name: "Ocean Academy",
      sameAs: "https://oceanacademy.in",
    },
    jobLocation: {
      "@type": "Place",
      address: {
        "@type": "PostalAddress",
        streetAddress: "Puducherry",
