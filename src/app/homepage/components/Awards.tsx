...
import { AWARD1, AWARD2, CK, MIT, PU, SMVC } from "@/assets";
...
export const Awards = () => {
  const awardsData = [
    ...
    },
    {
      ...
      text: "Synchronization of Knowledge & Information Network",
    },
  ];
  ...
  <main className="max-w-[1200px] mx-auto text-center">
    ...
    <div className="flex flex-wrap justify-center gap-[30px] mt-[30px] p-4">
      {awardsData.map((award) => (
        <article
          key={award.id}
          className="bg-white w-[250px] flex flex-col items-center rounded-[10px] p-6 shadow-sm"
          itemScope
          itemType="https://schema.org/Award"
        >
          <p className="text-[13px] font-[600] mb-2">Recognized by</p>
          ...
          <p
            className="text-[11px] font-[500] text-center whitespace-pre-line mt-6"
            itemProp="name"
          >
            {award.text}
          </p>
