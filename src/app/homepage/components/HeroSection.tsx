...
import { CAREERGUIDANCE, ICON,  OATHUMB, REVIEW_VIDEO, SEMINARS, STUDENTCOUNT, TOPPATTERN, WORKSHOP } from "@/assets";
    ...
    <section className="bg-gradient-to-t from-[#056f9c] to-[#189bd8] py-[50px] px-[16px]  relative overflow-hidden">
      ...
      <div className="max-w-[1200px] mx-auto flex gap-[40px] items-center justify-center max-[1150px]:flex-col-reverse relative z-10">
        ...
        <section className="relative">
          <div className="relative group  w-fit max-[700px]:w-[]">
            {/* Video */}
            <video
              ref={videoRef}
          ...
          {/* Stats Below Video */}
          <div className="mt-4 flex flex-wrap gap-[15px] justify-start  absolute top-[290px] left-[-65px]">
            <div className="flex items-center gap-[5px] rounded-[8px] px-[6px] py-2 shadow-[0_35px_35px_rgba(0,0,0,0.25)] bg-[#ffffff] h-[60px] w-[100px]">
              <img src={ICON.src} alt="students" className="h-[35px] w-[35px] " />
              <p className="text-[#056f9c]  font-[500] text-[12px]">10K+ <br />Students</p> 
            </div>
            <div className="flex items-center gap-[5px] rounded-[8px] px-[6px] py-2 shadow-[0_35px_35px_rgba(0,0,0,0.25)] bg-[#ffffff] h-[60px] w-[140px]">
              <img src={ICON.src} alt="students" className="h-[35px] w-[35px] " />
              <p className="text-[#056f9c] font-[500] text-[12px]">75+ <br />Free seminars</p>
            </div>
          </div>
        </section>
      </div>
