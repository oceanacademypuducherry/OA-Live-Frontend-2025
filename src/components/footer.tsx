...
export const Footer = () => {
  return (
    <footer className="bg-[#003B57] text-white">
      ...
      {/* Footer Main */}
      <div className="max-w-[90%] lg:max-w-[80%] mx-auto px-4 md:px-8 py-5">
        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-5 md:gap-12 text-center sm:text-left items-center">
          {/* About Section */}
          <div className="flex justify-center sm:justify-start">
            <div>
              <h2 className="text-[24px] md:text-[28px] font-bold flex flex-col items-center sm:items-start gap-3">
              ...
              <div className="mt-4 text-[14px] md:text-[16px] leading-relaxed text-gray-200">
                <p>
                  ...
                  implementing great ideas that drive progress for the students
                  and clients.
                </p>
              </div>
          ...
          {/* Contact Info */}
          {/* Contact Info Column */}
<div className="flex flex-col justify-start sm:justify-start mb-11">
  <h3 className="text-lg font-semibold mb-4 text-sky-400">
    Contact Info
  </h3>

  <div className="flex flex-col gap-4 text-[14px] md:text-[16px] text-gray-200">
    {/* Location */}
    <div className="flex items-start sm:gap-2 gap-0">
      <FaMapMarkerAlt className="text-[16px] md:text-[18px] shrink-0 mt-0.5" />
      <p>No. 10, 2nd Floor, 45 Feet Road, Vengateswara Nagar, Near HDFC Bank, Saram, Puducherry-605013.</p>
    </div>

    {/* Phone */}
    <div className="flex items-center gap-2">
      <FaPhoneAlt className="text-[14px] md:text-[16px] shrink-0" />
      <span>0413-2240580</span>
    </div>

    {/* Email */}
    <div className="flex items-center gap-2">
      <FaEnvelope className="text-[14px] md:text-[16px] shrink-0" />
      <span>info@oceanacademy.in</span>
    </div>
  </div>
</div>
          ...
          {/* Quick Links */}
          <div className="flex justify-center sm:justify-start mt-13">
            <div>
